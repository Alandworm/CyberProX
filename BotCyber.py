...
=> .Youtube = pencarian youtybe
=> .Music = pancarian musik
...
admin=["u05f685b8af6b5ea603d1e7b04d0cbe3c"]
creator=["u05f685b8af6b5ea603d1e7b04d0cbe3c"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~alandworm",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~alandworm",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
            elif "Mang say " in msg.text:
					bctxt = msg.text.replace("MangErlan ","")
					ki.sendText(msg.to,(bctxt))
#-----------------------------------------------
            elif msg.text in ["Creator"]:
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u05f685b8af6b5ea603d1e7b04d0cbe3c"}
					cl.sendMessage(msg)
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					...
					kk.sendText(msg.to,"Jangan banyak nikung ok!")
#-----------------------------------------------
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line:://ti/p/~alandworm")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"km kereen bray")
						print "DiLike"
					except:
							pass
				else:
...
line_bot_api = LineBotApi('i4CLq4v9GPwm/OqLOguDUwdQAHVAJ1tT9TSJtElimNT9p2ew/PEv6mlo1Dcp+ryKZpHMFP0CXSvaNyJggB5vd5jjzFfbdoueB6b3dL7CTiIJbaldDNFXrpXwo0XWoXa1mPDQBwpU1YjoL2CglHg8wAdB04t89/1O/w1cDnyilFU=')   #I put my TOKEN
handler = WebhookHandler('5d96f0acf017faa0337ae4bc78bfb33b')
